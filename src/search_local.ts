...
export class LocalSearchModal extends Modal {
    ...
    caseSensitiveEl: HTMLInputElement;
    ...
    onOpen() {
        ...
        const searchAreaEl = contentEl.createEl('div', { cls: 'search-area' });
        this.createSearchInterface(searchAreaEl);
        
        this.resultsContainerEl = contentEl.createEl('div', { cls: 'search-results-container' });
        contentEl.addClass('local-search-content-wrapper');
        
        this.restoreLastSearch();
    }

    createSearchInterface(containerEl: HTMLElement) {
        ...
        this.keywordInputEl = inputContainerEl.createEl('input', {
        ...
        inputWrapperEl.appendChild(this.keywordInputEl);
        ...
        const caseSensitiveButtonEl = inputWrapperEl.createEl('button', {
        ...
        this.caseSensitiveEl = inputContainerEl.createEl('input');
        this.caseSensitiveEl.type = 'checkbox';
        this.caseSensitiveEl.style.display = 'none';
        
        caseSensitiveButtonEl.addEventListener('click', () => {
            this.caseSensitiveEl.checked = !this.caseSensitiveEl.checked;
            if (this.caseSensitiveEl.checked) {
    ...
    async executeSearch() {
        ...
        const caseSensitive = this.caseSensitiveEl.checked;
    ...
    displayResults(results: LocalSearchResult[]) {
        ...
        displayResults.forEach(result => {
            ...
            const titleEl = titleRowEl.createEl('div', { cls: 'local-search-title' });
